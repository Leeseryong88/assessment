        ...
        <div className="bg-blue-600 text-white py-2 overflow-hidden relative">
          <div className="flex items-center justify-center gap-2 px-4">
            <span className="text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
              ...
              Notice: Best experienced on Desktop for advanced analysis
            </span>
          </div>
        </div>
      )}
          ...
          <div className="w-full min-w-0">
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 mb-8">
              <div className="h-9 px-4 flex items-center bg-blue-50 rounded-full border border-blue-100 shrink-0">
                ...
                <div className="flex items-center gap-3 md:gap-5 mb-6 overflow-visible">
                  <h1 className="text-[26px] md:text-6xl lg:text-7xl font-black text-gray-900 tracking-tight leading-tight mb-0 whitespace-nowrap">
